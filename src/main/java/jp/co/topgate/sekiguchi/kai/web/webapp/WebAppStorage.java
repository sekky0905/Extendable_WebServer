...
import jp.co.topgate.sekiguchi.kai.web.webapp.bulletinboardapp.BulletinBoardApp;
import jp.co.topgate.sekiguchi.kai.web.webapp.staticserverapp.StaticServerApp;
...
public class WebAppStorage {
    ...
    public static void initApp() {
        WebApp staticWebServerApp = new StaticServerApp();
